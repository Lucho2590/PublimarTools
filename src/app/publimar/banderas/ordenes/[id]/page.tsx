...
export default function OrdenPage({ params }: { params: { id: string } }) {
  ...
  const handleStatusChange = async (newStatus: EOrderStatus) => {
    ...
    try {
      const orderRef = doc(firestore, collections.ORDERS, params.id);
        ...
        const saleData = {
            ...
            items: order.items.map((item: any) => {
              ...
              return {
                ...
                product: productData, // Incluir toda la información del producto
              };
            }),
            ...
            createdAt: new Date(),
            updatedAt: new Date(),
            orderId: order.id, // Referencia a la orden de trabajo
          };
          ...
          {!isDownload && (
            <>
              <Button
                ...
                variant="outline"
                onClick={() =>
                  redirect(`/publimar/banderas/ordenes/${params.id}/editar`)
                }
              >
                Editar
              </Button>
              ...
              <div className="space-y-6">
                ...
                {(order.balance || 0) > 0 && (
                  <div className="bg-white border rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div>
                        <Label htmlFor="pagoParcial" className="pb-1">
                          Monto
                        </Label>
                        <Input
                          id="pagoParcial"
                      ...
                      <div>
                        <Label htmlFor="metodoPago" className="p-1">
                          Método de pago
                        </Label>
                        <Select
                          value={metodoPago}
                        ...
                        {metodoPago === EPaymentMethod.TRANSFER && (
                          <div className="mt-2">
                            <Label htmlFor="banco" className="pb-1">
                              Banco
                            </Label>
                      ...
                      <div className="flex items-end">
                        <Button
                          ...
                          disabled={
                            loadingPago ||
                            !pagoParcial ||
                            (metodoPago === EPaymentMethod.TRANSFER && !banco)
                          }
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-slate-500">
                                {pago.method === EPaymentMethod.CASH
                                  ? "Efectivo"
                                  : pago.method === EPaymentMethod.CREDIT_CARD
                                  ? "Tarjeta de crédito"
                                  : pago.method === EPaymentMethod.DEBIT_CARD
                                  ? "Tarjeta de débito"
                                  : pago.method === EPaymentMethod.TRANSFER
                                  ? "Transferencia"
