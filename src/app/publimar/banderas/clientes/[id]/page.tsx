      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          ...
          <Button
            variant="outline"
            onClick={() =>
              router.push(`/publimar/banderas/clientes/${clientId}/editar`)
            }
          >
            Editar
          </Button>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {typedClient.contacts && typedClient.contacts.length > 0 && (
                  <div className="md:col-span-2">
                    <h3 className="font-semibold text-slate-700 mb-2">Personas de Contacto</h3>
                    <div className="space-y-4">
                      {typedClient.contacts.map((contact, index) => (
                      ...
                      <div className="flex justify-between items-start">
                        ...
                        <div className="flex gap-2">
                          <Button
                            ...
                            onClick={() =>
                              router.push(
                                `/publimar/banderas/presupuestos/${quote.number}`
                              )
                            }
                          >
                            Ver
                          ...
                          <Button
                            ...
                            onClick={() =>
                              router.push(
                                `/publimar/banderas/presupuestos/${quote.number}/editar`
                              )
                            }
                          >
                            Editar
