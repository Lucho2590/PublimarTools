  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        >
          <Link href="/dashboard/banderas/presupuestos/nuevo">
            Nuevo presupuesto
          </Link>
        </Button>
      </div>
                      ...
                      <TableRow key={quote.id}>
                        ...
                        <TableCell className="text-center">
                          <div className="flex justify-center gap-2">
                            <Link
                              href={`/dashboard/banderas/presupuestos/${quote.number}`}
                            >
                              <Button
                                variant="ghost"
                                size="icon"
                            ...
                            <Link
                              href={`/dashboard/banderas/presupuestos/${quote.number}/editar`}
                            >
                              <Button
                                variant="ghost"
                                size="icon"
