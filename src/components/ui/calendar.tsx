  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: "space-x-1 flex items-left justify-left",
        nav_button: cn(
          buttonVariants({ variant: "outline" }),
          "h-1 w-1 bg-transparent p-1 opacity-50 hover:opacity-100"
        ),
        nav_button_previous: "absolute ml-1 left-1",
        nav_button_next: "absolute mr-1 right-1",
